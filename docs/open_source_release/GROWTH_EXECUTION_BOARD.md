...
- 最新主分支的 CI、前端生产构建、Ubuntu/macOS 公共运行时 smoke test 和 OpenSSF Scorecard 均通过（当前验证提交 `51dab06`；当前发布为 [v0.1.9](https://github.com/tonyhyworld/TraceArena/releases/tag/v0.1.9)）。
