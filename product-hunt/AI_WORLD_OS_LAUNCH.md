# Product Hunt launch kit — AI World OS
...
Use one primary action in launch-day replies: **run the no-key replay**.
...
Then ask users to propose the smallest world they would load next.
